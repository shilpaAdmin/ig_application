        ...
        if(count($category) > 0)
        {
            ...
            foreach($category as $data)
            {
                ...
                if($parentCategoryId == 0)
                {
                    ...
                    $categoryData[$j]['Icon']= URL::to('public/images/categories').'/'.$data['media_file'];
                    ...
                    if(count($category) > 0)
                    {
                        ...
                        foreach($subCategorycategory as $data)
                        {
                            ...
                            $categoryData[$j]['Subcategories'][$k]['Icon'] = URL::to('public/images/categories').'/'.$data['media_file'];
