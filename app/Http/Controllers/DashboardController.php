...
class DashboardController extends Controller
{
    ...
    public function forumList(Request $request)
    {
        ...
        return DataTables::of($result_obj)
            ...
            ->rawColumns(['DT_RowId', 'question_td', 'description', 'url', 'user_id', 'is_approve'])
            ->make(true);
    }
    ...
    public function matrimonialList(Request $request)
    {
        ...
        $result_obj = MatrimonialModel::where('matrimonial.status', '!=', 'deleted')->orderBy('created_at','DESC')->limit(10)->get();
        ...
        return DataTables::of($result_obj)
            ...
            ->rawColumns(['DT_RowId', 'is_approve', 'full_name', 'city', 'caste', 'married'])
            ->make(true);
    }



    public function matrimonialApproveStatus(Request $request, $id)
    {
