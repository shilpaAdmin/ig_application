...
// Weekly Carousel2
    if ($(".weekly_carousel2").length) {
      $(".weekly_carousel2").owlCarousel({
        loop: true,
        margin: 30,
        nav: false,
        smartSpeed: 500,
...
// Weekly Carousel3
    if ($(".weekly_carousel3").length) {
      $(".weekly_carousel3").owlCarousel({
        loop: true,
        margin: 30,
        nav: false,
        smartSpeed: 500,
