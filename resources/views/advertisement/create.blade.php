...
@section('title') Advertisement Add @endsection
@section('css')
    ...
    <div class="col-12">
        <div class="card mb-2">
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('advertisement.store')}}" novalidate>
                    @csrf
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control" name="continously" id="continously" required>
                                        ...
                                        <option value="{{$continously}}">{{ucwords($continously)}}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-daterange input-group" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker">
                                            ...
                                            <input style="text-align: left !important;" type="text" placeholder="Enter Start Date" class="form-control" name="start_date" required />
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="input-daterange input-group" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker">
                                            ...
                                            <input style="text-align: left !important;" type="text" placeholder="Enter End Date" class="form-control" name="end_date" required />
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="url" id="url" placeholder="Advertisement URL" value="{{old('url')}}" required>
                                    <div class="invalid-feedback">
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control" name="type" id="type" required>
                                        ...
                                        <option value="{{$Advertisment_type}}">{{ucwords($Advertisment_type)}}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                        Please provide a Continously.
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input form-control" name="media" id="media" accept="image/*" required>
