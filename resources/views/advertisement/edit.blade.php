    ...
    <div class="col-12">
        <div class="card mb-2">
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('advertisement.update', $row['id'])}}" novalidate>
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="{{$row['name']}}" required>
                        ...
                        <div class="col-md-4">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description" placeholder="description" value="{{$row['description']}}" required>
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-control" name="continously" id="continously" required>
                                        <option value="">Select Continously</option>
                                        @foreach($continouslies as $continously)
                                        <option value="{{$continously}}" @if($row['continously']==$continously) selected @endif>{{ucwords($continously)}}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                        ...
                        <div>
                            <div class="input-daterange input-group" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker">
                                ...
                                <input style="text-align: left !important;" type="text" placeholder="Enter Start Date" class="form-control" name="start_date" value="{{ $row['start_date']}}" required />
                        ...
                        <input type="text" class="form-control" name="url" id="url" placeholder="Advertisement URL" value="{{$row['url']}}" required>
                        <div class="invalid-feedback">
                        ...
                        <select class="form-select form-control" name="type" id="type" required>
                            ...
                            <option value="{{$Advertisment_type}}" @if ($row['type']==$Advertisment_type) selected @endif>{{ucwords($Advertisment_type)}}</option>
                            @endforeach
                        </select>
                        <div class="invalid-feedback">
                            Please provide a Continously.
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input form-control" name="media" id="media" accept="image/*" @if($row['media']=='' ) required @endif>
