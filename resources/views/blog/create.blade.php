...
@endsection @section('content') @component('common-components.breadcrumb') @slot('title') Add Blog @endslot @slot('li_1') Blog @endslot @slot('li_2') Add @endslot @endcomponent
<style>
    .imgdisplay-blog {
    height: 200px;
    width: 200px;
    ...
    <div class="col-12">
        <div class="card mb-2">
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('blog.store')}}" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="repeater main-repeter">
                        <div data-repeater-list="group-a">
                            <div data-repeater-item class="row">
                                <div class="col-lg-3">
                                <div class="small-pic">
                                        <img class="imagePreview2 mb-3 imgdisplay-blog" alt="" src="{{URL::asset('images/image-placeholder.jpg')}}" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <input type="file" class="custom-file-input media_file form-control" name="media_file_json" id="media_file" accept="image/*" required />
                        ...
                        <button type="button" data-repeater-create class="btn btn-primary waves-effect btn-sm btn-label-btn-sm btn-label waves-light margin-left-btn mt-2"><i class="bx bx-plus label-icon"></i> Add New</button>
                    </div>
                    <br />
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tagged" id="tagged" required placeholder="Tagged" value="{{old('description')}}" />
                            <div class="invalid-feedback">
