                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="post" enctype="multipart/form-data"
                        ...
                        <div class="repeater main-repeter">
                            <div data-repeater-list="group-a">
                                <div data-repeater-item class="row">
                                    <div class="col-lg-4 ">
                                        <input type="file" class="custom-file-input media_file form-control" name="media_file_json" id="media_file"
										...
										<div class="small-pic">
                                        <img class="imagePreview2" alt="" width="200" height="200" src="{{URL::asset('images/image-placeholder.jpg')}}" />
                                    </div><br>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tagged" id="tagged"
                            required  placeholder="Tagged" value="{{old('description')}}">
                            <div class="invalid-feedback">
