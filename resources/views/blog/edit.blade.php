    ...
    <div class="col-12">
        <div class="card mb-2">
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" enctype="multipart/form-data" action="{{ route('blog.update', $row['id']) }}" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="formrow-firstname-input">Name</label>
                                <input type="text" class="form-control" name="name" id="name" required placeholder="Name" value="{{ $row['name'] }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="description" id="description" required placeholder="Description" value="{{ $row['description'] }}">
                                <div class="invalid-feedback">
            ...
            <div class="repeater main-repeter">
                <div data-repeater-list="group-a">
                    ...
                    @for ($k = 0; $k < count($attachmentArray); $k++) <div data-repeater-item class="row">
                        <div class="col-md-4 col-lg-3">
                            <div class="small-pic newsmallpic">
                                @if (isset($attachmentArray[$k]) && !@empty($attachmentArray[$k]))
                                <img class="imagePreview2 imgdisplay-blog" alt="" src="{{ URL::asset('images/blogs/' . $attachmentArray[$k]) }}" />
                                @else
                                No Images
                                @endif
                            </div><br>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <input type="file" class="custom-file-input media_file form-control" name="group-a[0][media_file_json]" id="media_file" accept="image/*" required>
                            <div class="invalid-feedback">
                                Media File is required !
                            </div>
                            <input type="hidden" name="group-a[0][media_file_json_from_db]" value="{{ $attachmentArray[$k] }}">
                            <label class="custom-file-label" for="customFile">Image</label>
                            <br><br>
                        </div>

                        <div class="col-md-1 col-lg-1">
                            <button type="button" data-repeater-delete data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-sm btn-danger mt-2 mb-2">
            ...
            <button type="button" data-repeater-create class="btn btn-primary waves-effect btn-sm btn-label-btn-sm btn-label waves-light margin-left-btn addbtnforall newsmallpic21"><i class="bx bx-plus label-icon"></i>
                Add New</button>
        </div><br>
            ...
            <div class="col-lg-4">
                <div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tagged" id="tagged" required placeholder="Tagged" value="{{ $row['tagged'] }}">
                        <div class="invalid-feedback">
            ...
            <div class="col-lg-4">
                ...
                <div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="url" id="url" required placeholder="URL" value="{{ $row['url'] }}">
                        <div class="invalid-feedback">
