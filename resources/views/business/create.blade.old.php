                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="post" enctype="multipart/form-data"
                        ...
                        <div class="repeater">
                            ...
                            class="btn btn-primary waves-effect btn-sm btn-label-btn-sm btn-label waves-light"><i class="bx bx-plus label-icon"></i>
                            Add New</button>
                        </div>
                        ...
                        <div class="repeater main-repeter">
                            <div data-repeater-list="related_personal_detail">
                                <div data-repeater-item class="row">
                                <div class="col-lg-4 top-img-call">
                                    <input type="file" class="custom-file-input form-control top-img-call" name="related_person_image" id="related_person_image"
                                    accept="image/*" required>
                                    <label class="custom-file-label" for="customFile">Image</label>
                                    <div class="invalid-feedback invalid-feedback-pic">
                                       Related Person Image is required !
                                    </div>
									<div class="my-2"> <img class="imagePreview" alt="" width="100" height="100" src="{{URL::asset('images/image-placeholder.jpg')}}" /></div>
                                    ...
                                    <div class="col-lg-1">
                                        <button type="button" data-repeater-delete data-toggle="tooltip" data-placement="top"
                                        title="Delete" class="btn btn-sm btn-danger top-img-call">
                                        <i class="bx bx-trash d-block font-size-16"></i>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <button type="button" data-repeater-create
                            class="btn btn-primary waves-effect btn-sm btn-label-btn-sm btn-label waves-light margin-left-btn"><i class="bx bx-plus label-icon"></i>
                            Add New</button>
                        </div>
