                    ...
                    <input type="hidden" value="{{ $row['id'] }}" name="id">
                                ...
                                <div class="form-check mr-2">
                                    <input class="form-check-input" type="radio" name="type" id="productRadio"
                                        value="product" @if ($row['type'] == 'product') checked @endif>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-control" name="user_id" id="user_id">
                                            ...
                                            @foreach ($users as $userid => $username)
                                                <option @if ($row['user_id'] == $userid) selected @endif value="{{ $userid }}">
                                ...
                                <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-select form-control form-control-lg" data-search="on" required
                                            name="txtSearchTag" id="txtSearchTag">
                                        </select>
                            ...
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <div class="form-group" id="categoryDiv">
                                        ...
                                        <select class="form-select form-control txtSearchKeyword-box" data-search="on"
                                            name="txtSearchCategory" id="txtSearchCategory" required>
                                        </select>
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Business Name" value="{{ $row['name'] }}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="about" value="{{ $row['about'] }}"
                                            id="about" placeholder="Business About" required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="address"
                                            value="{{ $row['address'] }}" id="address" placeholder="Business Address"
                                            required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="description"
                                            value="{{ $row['description'] }}" id="description"
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sub_description"
                                            value="{{ $row['sub_descrition'] }}" id="sub_description"
                                            placeholder="Business Sub Description" required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sub_description1"
                                            value="{{ $row['sub_description_1'] }}" id="sub_description1"
                                            placeholder="Business Sub Description 1" required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="actual_price"
                                            value="{{ $row['actual_price'] }}" min="0" id="actual_price"
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="actual_price_unit"
                                            value="{{ $row['actual_price_unit'] }}" id="actual_price_unit"
                                            placeholder="Actual Price Unit" required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="selling_price"
                                            value="{{ $row['selling_price'] }}" min="0" id="selling_price"
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="selling_price_unit"
                                            value="{{ $row['selling_price_unit'] }}" id="selling_price_unit"
                                            placeholder="Selling Price Unit" required>
                                        <div class="invalid-feedback">
                        ...
                        <div class="repeater">
                                        ...
                                        @if (!empty($times) && isset($times))
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-3">
                                                    ...
                                                    <select class="form-select form-control" name="txtDay[]" id="txtDay"
                                                        required>
                                                        <option value="">Select Day</option>
                                                        @foreach ($days as $name => $Name)
                                                            <option value={{ $name }} @if ($name == $displayday) selected @endif>
                                                                {{ $Name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="timepicker" type="text" class="form-control"
                                                            name="start_time[]" data-provide="timepicker"
                                                            value="{{ !empty($start_time) ? str_replace('.', '', $start_time) : '' }}"
                                                            required>
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="timepicker" type="text" class="form-control"
                                                            name="end_time[]" data-provide="timepicker"
                                                            value="{{ !empty($end_time) ? str_replace('.', '', $end_time) : '' }}"
                                                            required>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i
                                                                    class="mdi mdi-clock-outline"></i></span>
                                                ...
                                                <div class="col-lg-1 align-self-center">
                                                    <button type="button" data-repeater-delete data-toggle="tooltip"
                                                        data-placement="top" class="btn btn-danger mt-2">
                            ...
                            <button type="button" onclick="addHoursFunction()"
                        ...
                        <div class="repeater">
                            <div data-repeater-list="related_personal_repeater">
                                ...
                                @if (!empty($row['related_person_detail_arr']) && $count_person_detail > 0)
                                    ...
                                    @for ($i = 0; $i < $count_person_detail; $i++)
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <input type="file" class="custom-file-input related_person form-control"
                                                    name="related_person_old_image[]" id="related_person_image"
                                                    accept="image/*">
                                                <input type="hidden" name="related_person_image_files[]"
                                                    value="{{ $row['related_person_detail_arr'][$i]['RelatedPersonImage' . ($i + 1)] }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="related_person_details[]" class="form-control"
                                                        value="" id="related_person_details"
                                                        placeholder="Related Person Details"
                                                        required>{{ $row['related_person_detail_arr'][$i]['RelatedPersonDetail' . ($i + 1)] }}</textarea>
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="col-lg-3">
                                                <img class="imagePreview" alt="" width="100" height="100"
                                                    src="{{ URL::asset('images/business_related_person/' . $row['related_person_detail_arr'][$i]['RelatedPersonImage' . ($i + 1)]) }}" />
                                            </div>
                                            <div class="col-lg-1 align-self-center">
                                                <button type="button" data-repeater-delete data-toggle="tooltip"
                                                    data-placement="top" class="btn btn-danger mt-2">
                            ...
                            <button type="button" onclick="addRelatedPersonFunction()"
                        ...
                        <div class="repeater">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <input type="file" class="custom-file-input form-control"
                                                    id="attachment_files_json" name="group-a[0][media_file_json]" />
                            ...
                            <button type="button" onclick="addMediaFunction()"
                                class="btn btn-primary waves-effect btn-label waves-light"><i
                                    class="bx bx-plus label-icon"></i>
                                Add New</button>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="job_salary" class="form-control" value="" id="job_salary"
                                        placeholder="Job Salary" required>{{ $job_detail_obj['JobSalary'] }}</textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control"
                                        value="{{ $job_detail_obj['JobExperience'] }}" id="job_experiance"
                                        placeholder="Job Experiance" min="0" max="50" name="job_experiance"
                                        required></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="job_qualification" class="form-control" value=""
                                        id="job_qualification" placeholder="Job Qualification"
                                        required>{{ $job_detail_obj['JobQualification'] }}</textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="contact_person_name"
                                            value="{{ $row['contact_person_name'] }}" id="contact_person_name"
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="mobile_number"
                                            value="{{ $row['mobile_number'] }}" id="mobile_number"
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="email_id"
                                            value="{{ $row['email_id'] }}" id="email_id" placeholder="Email Id" required>
                                        <div class="invalid-feedback">
                    ...
                    <div class="invalid-feedback">
                        Please provide a Job Qualification.
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="unit_option"
                                            value="{{ $row['unit_option'] }}" id="unit_option" placeholder="Unit Option"
                                            required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="reference_url"
                                            value="{{ $row['reference_url'] }}" id="reference_url"
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="syllabus"
                                            value="{{ $row['syllabus'] }}" id="syllabus" placeholder="Syllabus" required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="website"
                                            value="{{ $row['website'] }}" id="website" placeholder="Website" required>
                                        <div class="invalid-feedback">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="payment_mode"
                                            value="{{ $row['payment_mode'] }}" id="payment_mode" placeholder="Payment Mode"
                                            required>
                                        <div class="invalid-feedback">
                        ...
                        <input type="hidden" name="hdnSearchCategoryId" id="hdnSearchCategoryId"
                            value="{{ !empty($row['category_id']) ? $row['category_id'] : '' }}">
                    </form>
                </div>
            </div>
                            ...
                            success: function(obj) {
                                ...
                                if (obj.status == true) {
                                    ...
                                    for (var key in obj.data) {
                                        ...
                                        html +=
                                            "<div class='col-sm-3'><div class='custom-control custom-checkbox'><input type='checkbox' name='subcategory[]' id='" +
                                            id + "' class='custom-control-input subcategory' value='" + id +
                                            "' onchange='showHide()' " + checkedFlag +
                                    ...
                                    $('#category_result').append(
                                        '<div class="invalid-feedback" id="subcategoryError">Select atleast one subcategory !</div>'
                                        );
                                    console.log(html);
                                } else {
                                    $('#category_result').html(
                                        '<div class="formrow-firstname-input">No Sub-Categories Found!</div>'
                                        );
                                }
                            },
                            error: function(html) {
