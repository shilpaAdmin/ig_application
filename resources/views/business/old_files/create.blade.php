            ...
            <div class="card mb-2">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="post" enctype="multipart/form-data"
                        action="{{route('business.store')}}" onsubmit="checkSubCategoriesChecked()" novalidate>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-control form-control-lg" data-search="on" multiple="multiple"
                            name="txtSearchTag" id="txtSearchTag" required>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="address" value="{{old('address')}}"
                                id="address" placeholder="Business Address" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="description" value="{{old('description')}}"
                                id="description" placeholder="Business Description" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sub_description" value="{{old('sub_description')}}"
                                id="sub_description" placeholder="Business Sub Description" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sub_description1" value="{{old('sub_description1')}}"
                                id="sub_description1" placeholder="Business Sub Description 1" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="actual_price" value="{{old('actual_price')}}" min="0"
                                id="actual_price" placeholder="Actual Price" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="actual_price_unit" value="{{old('actual_price_unit')}}"
                                id="actual_price_unit" placeholder="Actual Price Unit" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="selling_price" value="{{old('selling_price')}}" min="0"
                                id="selling_price" placeholder="Selling Price" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="selling_price_unit" value="{{old('selling_price_unit')}}"
                                id="selling_price_unit" placeholder="Selling Price Unit" required>
                            <div class="invalid-feedback">
                            ...
                            <div data-repeater-list="hours_detail">
                                <div data-repeater-item class="row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <div class="input-group">
                                            <input id="timepicker" type="text" class="form-control " name="end_time"
                                                data-provide="timepicker" required>
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="mdi mdi-clock-outline"></i></span>
                                            </div>
                                    ...
                                    <div class="col-lg-1 align-self-center">
                                        ...
                                        title="Delete" class="btn btn-danger mt-2">
                        ...
                        <div class="repeater">
                            <div data-repeater-list="related_personal_detail">
                                <div data-repeater-item class="row">
                                <div class="col-lg-4">
                                    <input type="file" class="custom-file-input form-control" name="related_person_image" id="related_person_image"
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="avatar-edit">
                                        <input type="file" name="license_proof" id="LicensesImage" onchange="readURL2(this);" accept=".png, .jpg, .jpeg">
                                        <label for="LicensesImage"></label>
                                    </div>
                                    <div class="avatar-preview container2">
                                        <div id="imagePreviewLicenses" style="background-image: url({{URL::asset('images/image-placeholder.jpg')}})">
                                ...
                                --}}
                                    {{--
                                        <div class="col-lg-3">
                                              <div class="form-group">
                                                <label class="form-label" for="default-06">Media File</label>
                                                 <div class="avatar-upload">
                                                    <div class="avatar-edit">
                                                       <input type='file' name="media_file" id="imageUploadProfile" accept=".png, .jpg, .jpeg, .gif" name="avatar"  required/>
                                                    ...
                                                    <div class="avatar-preview container2">
                                                       <div id="imagePreviewProfile" style="background-image: url({{URL::asset('images/image-placeholder.jpg')}})"></div>
                                                    </div>
                                                 </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="related_person_details" class="form-control" value="{{old('related_person_details')}}"
                                            id="related_person_details" placeholder="Related Person Details" required></textarea>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-lg-3">
                                        <img class="imagePreview" alt="" width="100" height="100" src="{{URL::asset('images/image-placeholder.jpg')}}" />
                                    </div>
                                    <div class="col-lg-1 align-self-center">
                                        <button type="button" data-repeater-delete data-toggle="tooltip" data-placement="top"
                                        title="Delete" class="btn btn-danger mt-2">
                        ...
                        <div class="repeater">
                            <div data-repeater-list="media_detail">
                                <div data-repeater-item class="row">
                                    <div class="col-lg-4">
                                        <input type="file" class="custom-file-input media_file form-control" name="media_file" id="media_file"
                                        accept="image/*" required>
                                        <label class="custom-file-label" for="customFile">Image</label>
                                        <div class="invalid-feedback invalid-feedback-pic">
                                            Media File is required !
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="job_salary" class="form-control" value="{{old('job_salary')}}"
                                    id="job_salary" placeholder="Job Salary" required></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="{{old('job_experiance')}}"
                                    id="job_experiance" placeholder="Job Experiance" min="0" max="50" 
                                    name="job_experiance" required>
                                    </textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="job_qualification" class="form-control" value="{{old('job_qualification')}}"
                                    id="job_qualification" placeholder="Job Qualification" required></textarea>
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="contact_person_name" value="{{old('contact_person_name')}}"
                                id="contact_person_name" placeholder="Contact Person Name" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="email_id" value="{{old('email_id')}}"
                                id="email_id" placeholder="Email Id" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="unit_option" value="{{old('unit_option')}}"
                                id="unit_option" placeholder="Unit Option" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="reference_url" value="{{old('reference_url')}}"
                                id="reference_url" placeholder="Reference Url" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="syllabus" value="{{old('syllabus')}}"
                                id="syllabus" placeholder="Syllabus" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="website" value="{{old('website')}}"
                                id="website" placeholder="Website" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="payment_mode" value="{{old('payment_mode')}}"
                                id="payment_mode" placeholder="Payment Mode" required>
                            <div class="invalid-feedback">
