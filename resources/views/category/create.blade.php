    ...
    <div class="col-12">
        <div class="card mb-2">
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" enctype="multipart/form-data" action="{{route('category.store')}}" novalidate>
                    @csrf
                        ...
                        <div class="col-md-4">
                            <div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Category Name" value="{{old('category_name')}}" required>
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input form-control" name="media_file" id="media_file" accept="image/*" required>
