                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            <div class="row m-0">
                                ...
                                <div class="form-check mr-2">
                                    <input class="form-check-input" name="type" type="radio" id="categoryRadio" value="category" >
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control" name="media_file" id="media_file"
                                           accept="image/*" @if($row['media_file']=='') required @endif >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <!--<img src="@if($row['media_file']!='' && file_exists(public_path().'/images/categories/'.$row['media_file'])){{ URL::asset('/images/categories/'.$row['media_file']) }} @endif" id="imageview" width="400px" />-->
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                ...
                                @if($row['status']=='active' ) checked @endif name="status" value="Active" >
...
<script>
    ...
    @if(isset($sub_category_data) && $row['parent_category_id']!=0)
        var $option = $("<option selected></option>").val({{$sub_category_data->id}}).text('{{$sub_category_data->name}}');
...
$('#txtSearchCategory').on('select2:unselect', function (e) {
    ...
    @if($row['parent_category_id']==0)
        $("#categoryRadio").attr('checked', true).trigger('change');
    @else
        $("#subcategoryRadio").attr('checked', true).trigger('change');
    @endif
