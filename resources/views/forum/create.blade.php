...
@endsection @section('content') @component('common-components.breadcrumb') @slot('title') Add Forum @endslot
@slot('li_1') Forum @endslot @slot('li_2') Add @endslot @endcomponent
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="telegram_link" id="telegram_link"
                                    required placeholder="Telegram Link" value="{{ old('telegram_link') }}" />
                                <div class="invalid-feedback">
