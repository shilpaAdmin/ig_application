...
<div class="header_top_one_inner_right float-right">
                    ...
                    <div class="container-box clearfix">
                        ...
                        <div class="main-nav__left main-nav__left_one float-left">
                            <div class="logo_one">
                                <a href="index.html" class="main-nav__logo">
                                    <img src="assets/images/resources/logo-black2.png" class="main-logo" alt="Awesome Image">
                                </a>
                            </div>
                        ...
                        <div class="main-nav__main-navigation one float-left">
                            <ul class="main-nav__navigation-box">
                                <li> <a class="" href="index.html">Home</a></li>
                                  ...
                                  <li> <a href="forum-listing.html">Forum</a></li>
                        ...
                        <div class="main-nav__right main-nav__right_one float-right">
                            ...
                            <div class="dw_btnss float-right px-1 d-inline-block">
                                <a href="#" class=""> <img src="assets/images/resources/appstore.png"> </a>
                            </div>

                            <div class="dw_btnss float-right  px-1 d-inline-block">
                                <a href="#" class=""> <img src="assets/images/resources/playstore.png"> </a>
                            </div>
        ...
        <section class="page-header backgroundimgprivacy">
            ...
            <div class="container">
                <h2 class="h2_oth_pgs">Disclaimer</h2>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="privacy_box">
                            ...
                            <ul class="list-unstyled">
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> Product / Service or  </li>
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> Product / Service of any subscriber / advertiser or  </li>
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i></i> Product / Service of any particular subscriber / advertiser.  </li>
                            </ul>
                        </div>
                    </div> 
                    ...
                    <div class="col-12">
                        <div class="privacy_box">
                            ...
                            <p> We are committed to protecting the privacy and confidentiality of all Personal Information that you may share as a user of Media. In furtherance thereof, we have this policy to demonstrate our good faith. </p>
                            <p>This Privacy Policy is incorporated into and is subject to the our Terms of Service. Your use of the  Site, Our Software and Service and any personal information you provide remains subject to the terms of this Privacy Policy and our Terms of Service.</p>

                            <h6>What Does This Privacy Policy Cover ?</h6>
                            <p>This Privacy Policy is part of our Terms of Service and covers the treatment of user information, including personally identifying information, obtained by us, including information obtained when you access the Site, use the Service or any other software provided by us.</p>
                     ...
                     <div class="col-12">
                        <div class="privacy_box">
                            ...
                            <p>We may obtain the following types of information from or concerning you or your mobile phone device, which may include information that can be used to identify you as specified below ("Personally Identifying Information") : </p>

                            <ul class="list-unstyled">
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> You provide certain Personally Identifiable Information, such as your mobile phone number, and mobile device information to us when choosing to participate in various uses of the Justdial Service, such as registering as a user, and viewing ratings of contacts in your address book. In order to provide the our Service, we will periodically access your address book or contact list on your mobile phone to locate the mobile phone numbers that have been used to avail our services and to provide ratings of establishments we have received from users of these mobile numbers. We may access your location information to provide search results based on your geo location. This allows the software to provide relevant search results. Location data gathered from a mobile phone is used only to provide search results and is not used in any other manner whatsoever.  </li>

                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> For some of the service offerings, a user may have to part with financial data which is required to execute a particular service request for example booking a flight ticket, bus & train ticketing, UPI payments, Send payment to vendors, Bill pay and recharge etc. A user may not part with the information for which the service offering won't be available. </li>
                            </ul>
                     ...
                     <div class="col-12">
                        <div class="privacy_box">
                            ...
                            <p> IG is currently ad-free and we hope to keep it that way forever. We have no intention to introduce advertisement into the product, but if we ever do, we will update this section. </p>
                            <h4>Our Commitment to Data Security:</h4>
                            <p>Justdial uses commercially reasonable physical, managerial, and technical safeguards to preserve the integrity and security of your personal information. We cannot, however, ensure or warrant the security of any information you transmit to Justdial and you do so at your own risk.</p>

                            <h4>Consent To Push Notification</h4>
                            <p>You agree and confirm that any review, rating and comments, including any other content or data therein, that you submit/post on IG platforms viz. WEB, WAP, APP & Phone etc. such details as per Just Dial's discretion will be shared with your Tagged Friends who are the users of Just Dial's services.</p>
                     ...
                     <div class="col-12">
                        <div class="privacy_box">
                            ...
                            <p> Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Quaerat fugit ut vitae et unde in vel, nihil, quia esse blanditiis excepturi quo quas aut dolorem cupiditate officia a nemo animi! </p>
                            <ul class="list-unstyled">
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> Lorem ipsum dolor sit amet.  </li>
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> Lorem ipsum dolor sit amet, consectetur, adipisicing elit. Adipisci, natus? Lorem ipsum dolor sit amet, consectetur, </li>
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i></i> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis pariatur aliquid cupiditate perferendis rem, molestiae. Lorem ipsum dolor sit.</li>
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> Lorem ipsum dolor sit amet, consectetur, adipisicing elit. Adipisci, natus? Lorem ipsum dolor sit amet, consectetur, </li>
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i></i> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis pariatur aliquid cupiditate perferendis rem, molestiae. Lorem ipsum dolor sit.</li>
                            </ul>
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="privacy_box">
                            ...
                            <ul class="list-unstyled">
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> Lorem ipsum dolor sit amet.  </li>
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i> Lorem ipsum dolor sit amet, consectetur, adipisicing elit. Adipisci, natus? Lorem ipsum dolor sit amet, consectetur, </li>
                                <li> <i class="fas fa-circle font_small10 text_green pr-3"></i></i> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis pariatur aliquid cupiditate perferendis rem, molestiae. Lorem ipsum dolor sit. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis pariatur aliquid cupiditate perferendis rem, molestiae. Lorem ipsum dolor sit</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-12 border_bottom">
                        <a href="index.html" class="footernavbart"><img src="assets/images/img/footer-logo.png"></a>
                        <a href="about.html" class="footernavbart float-md-right">About us</a>
                        <a href="career.html" class="footernavbart  float-md-right ">Careers</a>
                        <a href="contact.html" class="footernavbart  float-md-right ">Contact us</a>
                ...
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <a href="forum-listing.html"  class="sunlilist">Forum</a>
                        <a href="#" data-toggle="modal" data-target="#exampleModal4" class="sunlilist">Education</a>
                        <a href="matrimoney-listing-grid.html" class="sunlilist">Matrimonial</a>
                        <a href="#" data-toggle="modal" data-target="#exampleModal7" class="sunlilist">Jobs</a>
                        <a href="#" data-toggle="modal" data-target="#exampleModal8" class="sunlilist">Travel & Transport</a>
                        <a href="faq.html" class="sunlilist">FAQ</a>
                 ...
                 <div class="row mb-3">
                    <div class="col-lg-12">
                        <div class="POPULARll">  QUICK LINKS  </div>
                        <a href="privacy-policy.html" class="sunlilist">Privacy Policy</a>
                        <a href="terms-services.html" class="sunlilist">Terms & Condition</a>
                        <a href="disclaimer.html" class="sunlilist">Disclaimer</a>
                        <a href="faq.html" class="sunlilist">FAQ</a>
                        <a href="forum-listing.html" class="sunlilist">Forum</a>
                        <a href="gdpr-notice.html" class="sunlilist">GDPR Notice</a>
                        <a href="contact.html" class="sunlilist">Contact IG</a>
                    </div>
                </div>
                ...
                <div class="row  mb-3">
                    <div class="col-lg-12">
                        ...
                        <div>
                            <a href="#" class="sunlilist">Berlin</a>
                            <a href="#" class="sunlilist">Hamburg</a>
                            <a href="#" class="sunlilist"> Munich</a>
                            <a href="#" class="sunlilist"> Cologne</a>
                            <a href="#" class="sunlilist">Stuttgart</a>
                            <a href="#" class="sunlilist">Dortmund</a>
                             
                            <a href="#" class="sunlilist">Essen</a>
                            <a href="#" class="sunlilist">Leipzig</a>
                            <a href="#" class="sunlilist">Bremen</a>
                            <a href="#" class="sunlilist">Dresden</a>
                            <a href="#" class="sunlilist">Berlin</a>
                            <a href="#" class="sunlilist">Hamburg</a>
                            <a href="#" class="sunlilist"> Munich</a>
                            <a href="#" class="sunlilist"> Cologne</a>
        ...
        <div class="site-footer_bottom">
            <div class="container">
                <div class="site-footer_bottom_copyright">
                    ...
                    <p><a href="#" class="footernavbart"><img src="assets/images/img/logo-only.png"></a>© Copyright
                        2021 by <a href="#">indiansingermany.de</a></p>
                </div>
