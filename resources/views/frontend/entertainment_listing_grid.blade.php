...
@section('title') Entertainment - Grid @endsection
@section('content')
    <!DOCTYPE html>
    <html lang="en">
    <body>
                            ...
                            <div class="filter_inner_content">
                                <div class="left">
                                    <div class="left_icon">
                                        ...
                                        <a href="{{route('EntertainmentListingList')}}" class="list-icon icon-list"></a>
                                    </div>
                                    <div class="left_text">
                            ...
                            <div class="listings_three-page_single wow fadeInUp animated" data-wow-delay="0ms"
                                ...
                                <div class="listings_three-page_content">
                                    ...
                                    <div class="listings_three-page_content_bottom">
                                        ...
                                        <div class="left">
                                            <a href="#" class="enqurebtnbox hvr-shutter-in-vertical">View Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
