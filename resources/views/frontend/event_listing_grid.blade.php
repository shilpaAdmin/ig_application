...
@section('title') event - Grid @endsection
@section('content')
    <!DOCTYPE html>
    <html lang="en">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="filter_inner_content">
                                <div class="left">
                                    <div class="left_icon">
                                        <a href="#" class="icon-grid active"></a>
                                        <a href="{{route('EventListingList')}}" class="list-icon icon-list"></a>
                                    </div>
                                    <div class="left_text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12">
                            ...
                            <div class="listings_three-page_single wow fadeInUp animated" data-wow-delay="0ms"
                                ...
                                <div class="listings_three-page_image">
                                    <img src="{{ URL::asset('assets/frontend/images/listings/event-grid.jpg')}}" alt="">
                                ...
                                <div class="listings_three-page_content">
                                    <div class="title">
                                        <h3><a href="job-details.html">CA After Party<span
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12">
                            ...
                            <div class="listings_three-page_single wow fadeInUp animated" data-wow-delay="0ms"
                                ...
                                style="visibility: visible; animation-duration: 1200ms; animation-delay: 0ms; animation-name: fadeInUp;">
                                <div class="listings_three-page_image">
                                    <img src="{{ URL::asset('assets/frontend/images/listings/event-grid2.jpg')}}" alt="">
                                    <div class="tag__promoted"> Promoted </div>
                                    <div class="heart_icon">
                                        <i class="icon-heart"></i>
                                    </div>
