...
@section('title') Housing List @endsection
@section('content')
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="filter_inner_content">
                            <div class="left">
                                <div class="left_icon">
                                    <a href="{{ route('HousingListingGrid')}}" class="icon-grid"></a>
                                    <a href="{{ route('HousingListingList')}}" class="list-icon icon-list active"></a>
                                </div>
                                <div class="left_text">
