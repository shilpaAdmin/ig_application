...
<div class="modal fade" id="exampleModallocation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <!-- Modal listing-->
                  ...
                  <div class="row">
                      <div class="col-xl-12 col-lg-12  wow zoomIn animated animated">
                          <div class="banner_three_top-title">
                              <h1>One stop solution<br> for  all Indians in &nbsp; &nbsp;<span style="font-size:90px;"> Germany.</span></h1>
                          ...
                          <div class="categories_one_carousel owl-theme owl-carousel">
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/housing111.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>Housing</h4>
                              </div>
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/taxation1.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>Taxation</h4>
                              </div>
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/forum1.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>Forum</h4>
                              </div>
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/education1.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>Education</h4>
                              </div>
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/matrimonial1.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>Matrmonial</h4>
                              </div>
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/travel1.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>Tours & Travel</h4>
                              </div>
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/faq1.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>FAQ</h4>
                              </div>
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/events1.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>Event</h4>
                              </div>
                              ...
                              <div class="categories_one_single">
                                  <div class="categories_one_icon">
                                      <span><img src="{{ URL::asset('assets/frontend/images/img/Entertainment1.png')}}" class="img-fluid"></span>
                                  </div>
                                  <h4>Entertainment</h4>
                              </div>
      ...
      <div class="food_lover_inner_shape-2" style="background-image: url({{ URL::asset('assets/frontend/images/shapes/food-lovers-shape-small2.png')}})"></div>
              ...
              <div class="container-full-width">
                  <div class="row catagorimain">
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          ...
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="0ms"
                              ...
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Housing.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Housing</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                          ...
                          <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                              ...
                              <div class="modal-dialog modal-lg modal-dialog-centered">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <div class="w-50 float-left"> <a class=" a_cat_color" href="{{ route('HousingListingGrid') }}"><i class="fas fa-angle-right"></i> House For Rent</a> </div>
                      ...
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          <!--Explore Categories Single-->
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="100ms"
                              data-wow-duration="1200ms"
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 100ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Taxasion.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Taxation</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                      <span type="button" data-toggle="modal" data-target="#exampleModal2"
                                          class="icon-right-arrow"></span>
                                  </button>
                              </div>
                          </div>
                          ...
                          <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel"
                              ...
                              <div class="modal-dialog modal-lg modal-dialog-centered">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <div class="w-50 float-left"> <a class=" a_cat_color" href="{{ route('TaxationListingGrid') }}"><i class="fas fa-angle-right"></i> Taxation</a> </div>
                      ...
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          <!--Explore Categories Single-->
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="200ms"
                              data-wow-duration="1200ms"
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 200ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Forum.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Forum</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                     <a href="{{ route('forumdetail') }}"><span class="icon-right-arrow"></span></a>
                                  </button>
                              </div>
                          </div>
                      ...
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          <!--Explore Categories Single-->
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="300ms"
                              data-wow-duration="1200ms"
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 300ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Education.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Education</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                      <span type="button" data-toggle="modal" data-target="#exampleModal4"
                                          class="icon-right-arrow"></span>
                                  </button>
                              </div>
                          </div>
                          ...
                          <div class="modal fade" id="exampleModal4" tabindex="-1" aria-labelledby="exampleModalLabel"
                              ...
                              <div class="modal-dialog modal-lg modal-dialog-centered">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <div class="w-50 float-left"> <a class=" a_cat_color" href="{{ route('EducationListingGrid') }}"><i class="fas fa-angle-right"></i> Education</a> </div>
                      ...
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          <!--Explore Categories Single-->
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="400ms"
                              data-wow-duration="1200ms"
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 400ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Matrimonial.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Matrimonial</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                     <a href="{{route('MatrimoneyListgrid')}}"> <span class="icon-right-arrow"></span> </a>
                                  </button>
                              </div>
                          </div>
                      </div>
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          ...
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="400ms"
                              ...
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 400ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Professional_services.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Jobs</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                      <span type="button" data-toggle="modal" data-target="#exampleModal7"
                                          class="icon-right-arrow"></span>
                                  </button>
                              </div>
                          </div>
                          ...
                          <div class="modal fade" id="exampleModal7" tabindex="-1" aria-labelledby="exampleModalLabel"
                              ...
                              <div class="modal-dialog modal-lg modal-dialog-centered">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <div class="w-50 float-left"> <a class=" a_cat_color" href="{{route('JobListingGrid')}}"><i class="fas fa-angle-right"></i> Jobs</a> </div>
                      ...
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          ...
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="400ms"
                              ...
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 400ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Travel_Transport.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Travel & Transport</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                      <span type="button" data-toggle="modal" data-target="#exampleModal8"
                                          class="icon-right-arrow"></span>
                                  </button>
                              </div>
                          </div>
                          ...
                          <div class="modal fade" id="exampleModal8" tabindex="-1" aria-labelledby="exampleModalLabel"
                              ...
                              <div class="modal-dialog modal-lg modal-dialog-centered">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <div class="w-50 float-left"> <a class=" a_cat_color" href="{{route('TourtravelListingGrid')}}"><i class="fas fa-angle-right"></i> Travel & Transport</a> </div>
                      ...
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          ...
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="400ms"
                              ...
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 400ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Faqq.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>FAQ</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                      <a href="{{ route('Faqs') }}"><span class="icon-right-arrow"></span></a>
                                  </button>
                              </div>
                          </div>
                      ...
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          ...
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="400ms"
                              ...
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 400ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Event.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Event</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                      <span type="button" data-toggle="modal" data-target="#exampleModal10"
                                          class="icon-right-arrow"></span>
                                  </button>
                              </div>
                          </div>
                          ...
                          <div class="modal fade" id="exampleModal10" tabindex="-1" aria-labelledby="exampleModalLabel"
                              ...
                              <div class="modal-dialog modal-lg modal-dialog-centered">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <div class="w-50 float-left"> <a class=" a_cat_color" href="{{route('EventListingGrid')}}"> <i class="fas fa-angle-right"></i> Event</a> </div>
                      ...
                      <div class="col-xl-2 col-lg-4 col-md-6">
                          ...
                          <div class="explore_categories_single wow fadeInUp animated" data-wow-delay="400ms"
                              ...
                              style="visibility: visible; animation-duration: 1200ms; animation-delay: 400ms; animation-name: fadeInUp;">
                              <div class="explore_categories_image">
                                  <img src="{{ URL::asset('assets/frontend/images/img/Entertainment.png')}}" alt="">
                              </div>
                              <div class="explore_categories_content">
                                  <h3>Entertainment</h3>
                                  <p>20 Listings</p>
                                  <button class="explore_categories_arrow">
                                        <a href="{{route('EntertainmentListingGrid')}}"><span class="icon-right-arrow"></span></a>
                                  </button>
                              ...
                              <div class="weekly_single">
                                  <div class="weekly_image">
                                      ...
                                      <div class="weekly_hover_content">
                                          <h3><a href="{{ route('HousingListingGrid') }}">Lorem ipsum is not free dolor sit amet</a>
                                          </h3>
                                          <p>Lorem ipsum is not free dolor sit amet</p>
                              ...
                              <div class="weekly_single3">
                                  <div class="weekly_image3">
                                      ...
                                      <div class="weekly_hover_content3">
                                          <h3><a href="{{route('EducationListingGrid')}}">Lorem ipsum is not free dolor sit amet</a>
                                          </h3>
                                          <p>Lorem ipsum is not free dolor sit amet</p>
  ...
  <div class="bg_pattern_honeybee2"></div>
                      ...
                      <div class="col-xl-4 col-lg-4 wow slideInLeft animated animated">
                          <div class="box_one">
                              <div class="box_one_img">
                                  <img src="{{ URL::asset('assets/frontend/images/resources/two-boxes-img-1.jpg')}}" alt="">
                      ...
                      <div class="col-xl-8 col-lg-8 wow slideInRight animated animated">
                          <div class="box_two">
                              <div class="box_two_img">
                                  <img src="{{ URL::asset('assets/frontend/images/resources/two-boxes-img-2.jpg')}}" alt="">
          ...
          <!--Food Lovers Start-->
          <section class="food_lovers" style="background-image: url({{ URL::asset('assets/frontend/images/backgrounds/food-lovers_bg.jpg')}})">
              <div class="food_lover_inner_shape-1"
                  style="background-image: url({{ URL::asset('assets/frontend/images/shapes/food-lovers-shape-1.png')}})"></div>
              <div class="container">
                  <div class="row">
                      <div class="col-xl-12">
          ...
          <section class="counter_one">
              <div class="counter_one_shape wow slideInLeft animated" data-wow-delay="600ms"
                  style="background-image: url({{ URL::asset('assets/frontend/images/shapes/counter_one_shape.png')}})"></div>
              <div class="container">
               ...
               <div class="row forum__box">
                      <div class="col-lg-1  for_profile">
                          <img src="{{ URL::asset('assets/frontend/images/img/d1.jpg')}}" class="f__img_left">
                           ...
                           <div class="col-lg-9 ">
                               <a href="{{ route('ForumList') }}" class="for__title">Sed sollicitudin tortor diam, in lobortis arcu porttitor eu. Aenean tempus quam dui. Mauris id scelerisque nibh, eu mollis est. Nulla rutrum tempus tristique?</a>
               ...
               <div class="row forum__box">
                      <div class="col-lg-1  for_profile">
                          <img src="{{ URL::asset('assets/frontend/images/img/d1.jpg')}}" class="f__img_left">
                           ...
                           <div class="col-lg-9 ">
                               <a href="{{ route('forumdetail') }}" class="for__title">Sed sollicitudin tortor diam, in lobortis arcu porttitor eu. Aenean tempus quam dui. Mauris id scelerisque nibh, eu mollis est. Nulla rutrum tempus tristique?</a>
   ...
   <!--FAQ One Start    style="background-image: url({{ URL::asset('assets/frontend/images/backgrounds/faq-one-bg.jpg')}})"-->
      ...
      <div class="food_lover_inner_shape-2" style="background-image: url({{ URL::asset('assets/frontend/images/shapes/food-lovers-shape-small2.png')}})"></div>
                  ...
                  <div class="row">
                      <div class="col-xl-4">
                          ...
                          <div class="blog_one_single wow fadeInUp" data-wow-delay="100ms">
                              <div class="blog_image">
                                  <img src="{{ URL::asset('assets/frontend/images/blog/blog-1-img-1.jpg')}}" alt="Blog One Image">
                              </div>
                              <div class="blog-one__content">
                                  ...
                                  <div class="blog_one_title">
                                      <h3><a href="{{ route('Blogdetail') }}">Top 8 Amazing Places to Stay in Canada</a></h3>
                                  </div>
                      ...
                      <div class="col-xl-4">
                          ...
                          <div class="blog_one_single wow fadeInDown" data-wow-delay="200ms">
                              <div class="blog_image">
                                  <img src="{{ URL::asset('assets/frontend/images/blog/blog-1-img-2.jpg')}}" alt="Blog One Image">
                              </div>
                              <div class="blog-one__content">
                                  <ul class="list-unstyled blog-one__meta">
                                      <li><a href=""><i class="far fa-user-circle"></i>by Admin</a></li>
                                  ...
                                  <div class="blog_one_title">
                                      <h3><a href="{{ route('Blogdetail') }}">Leverage agile frameworks to provide a robust</a>
                                      </h3>
                                  </div>
                                  <div class="blog_one_text">
                                      <p>Lorem ipsum dolor sit amet, cibo mundi ea duo, vim exerci phaedrum</p>
                      ...
                      <div class="col-xl-4">
                          ...
                          <div class="blog_one_single wow fadeInUp" data-wow-delay="300ms">
                              <div class="blog_image">
                                  <img src="{{ URL::asset('assets/frontend/images/blog/blog-1-img-3.jpg')}}" alt="Blog One Image">
                              </div>
                              <div class="blog-one__content">
                                  <ul class="list-unstyled blog-one__meta">
                                      <li><a href=""><i class="far fa-user-circle"></i>by Admin</a></li>
                                  ...
                                  <div class="blog_one_title">
                                      <h3><a href="{{ route('Blogdetail') }}">Bring to the table win-win survival strategies to</a>
                                      </h3>
                                  </div>
                                  <div class="blog_one_text">
                                      <p>Lorem ipsum dolor sit amet, cibo mundi ea duo, vim exerci phaedrum</p>
                      ...
                      <div class="col-xl-12">
                          <div class="cta_one_inner">
                              <div class="cta_one_inner_bg"
                                  style="background-image: url({{ URL::asset('assets/frontend/images/backgrounds/cta-2-bg.jpg')}})"></div>
          ...
          <section class="testimonials_one">
              <div class="" style="background-image: url({{ URL::asset('assets/frontend/images/shapes/testimonial-one-map.png')}})">
              </div>
                      ...
                      <div class="row review_box">
                          <div class="col-lg-6 col-xs-2 ">
                              <div class="video_one_imagee">
                                  ...
                                  <img src="{{ URL::asset('assets/frontend/images/resources/video-1-img-12.jpg')}}" alt="">
                      ...
                      <div class="col-xl-12">
                          <div class="video_one_image ">
                              <div class="video_one_shape-1"
                                  style="background-image: url({{ URL::asset('assets/frontend/images/shapes/video-1-shape-1.png')}})"></div>
                              <div class="video_one_shape-2 rotate-me"
                                  style="background-image: url({{ URL::asset('assets/frontend/images/shapes/video-1-shape-2.png')}})"></div>
          ...
          <section class="four_boxes">
              <div class="container">
                  ...
                  <div class="four_boxes_bottom">
                      <p>Don’t hesitate, contact us for better business. <a href="#" data-toggle="modal" data-target="#exampleModallisting">Start a New Lisiting</a></p>
                  </div>
              </div>
          </section>
