...
@section('title') Job Grid @endsection
@section('content')
<!DOCTYPE html>
<html lang="en">
<body>
                        ...
                        <div class="filter_inner_content">
                            <div class="left">
                                <div class="left_icon">
                                    ...
                                    <a href="{{ route('JobListingList') }}" class="list-icon icon-list"></a>
                                </div>
                                <div class="left_text">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        ...
                        <div class="listings_three-page_single wow fadeInUp animated" data-wow-delay="0ms"
                            ...
                            <div class="listings_three-page_image">
                                <img src="{{ URL::asset('assets/frontend/images/listings/job-grid.jpg')}}" alt="">
