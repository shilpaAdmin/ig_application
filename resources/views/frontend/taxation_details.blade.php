                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="main_bottom_left">
                            ...
                            <div class="main_bottom_left_title">
                                <h4>KS & Association<i class="fa fa-check"></i></h4>
        ...
        <section class="mt-5 mb-5">
            <div class="container">
                <div class="row mb-4">
                    ...
                    <div class="col-6 text-right"> <a href="taxation-listing-list.html" class="link-simple"> View
                            All </a> </div>
                </div>
                        ...
                        <div class="listings_two_page_content">
                            ...
                            <div class="listings_two_page_single">
                                <div class="listings_two_page_img">
                                    <img src="{{ URL::asset('assets/frontend/images/listings/tax2.jpg')}}" alt="">
                                ...
                                <div class="listings_three-page_contentt pt-3">
                                    <div class="title">
                                        <h3><a href="taxation-details.html">KS & Association<span
                                    ...
                                    <ul class="list-unstyled listings_three-page_contact_info">
                                        <li>
                                            <a class="rating_listt" href="#">
                                                ...
                                                <span class="gry_clr"><i class="fas fa-star"> </i></span>
                                                <span class="clr_blackk">3.0</span> </a>
                                        </li>
