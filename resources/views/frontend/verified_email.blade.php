                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="login_box">
                       ...
                       <div class="text-center verify_img_box">
                           <img src="{{ URL::asset('assets/frontend/images/resources/verified-email.png')}}" alt="">
                       </div>
...
the Advertisement  </div>
                       ...
                       <button type="submit" class="btn btn-primary thm-btn2 px-5 mt-3 w-100">Send request for approval</button>
