...
<footer class="site-footer">
            ...
            <div class="site_footer_map" style="background-image: url({{ URL::asset('assets/frontend/images/resources/footer-map.png')}})"></div>
            <div class="container">
        ...
        <div class="site-footer_bottom">
            <div class="container">
                <div class="site-footer_bottom_copyright">
                    ...
                    <p><a href="#" class="footernavbart"><img src="{{ URL::asset('assets/frontend/images/img/logo-only.png')}}"></a>© Copyright
