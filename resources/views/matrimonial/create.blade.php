...
@endsection @section('content') @component('common-components.breadcrumb') @slot('title') Add Matrimonial @endslot {{-- @slot('li_1') <a href="{{ route('jobopeninglist') }}" class=""> Question Paper </a> @endslot --}} @slot('li_1')
    ...
    <div class="col-12">
        <div class="card mb-2">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="post" id="dataForm" action="{{route('matrimonial.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="city" name="city" placeholder="Enter city" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address" maxlength="100" required />
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="about	" name="about" placeholder="Enter about" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="height" name="height" placeholder="Enter Height" maxlength="100" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="input-daterange input-group" data-date-format="dd-mm-yyyy" data-date-autoclose="true" data-provide="datepicker">
                                        <input style="text-align: left !important;" type="text" onchange="agefinddata()" placeholder="Enter Birth Date" class="form-control" name="birth_date" id="birth_date" required />
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="age" name="age" placeholder="Enter age" maxlength="100" readonly />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="caste" name="caste" placeholder="Enter caste" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="subcaste" name="subcaste" placeholder="Enter Subcaste" maxlength="100" required />
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="designation" name="designation" placeholder="Enter Designation" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="desired_religion" name="desired_religion" placeholder="Enter Desired Religion" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="other" name="other" placeholder="Enter other" maxlength="100" required />
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="annual_income" name="annual_income" placeholder="Enter Annual Income" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="desired_mother_tongue" name="desired_mother_tongue" placeholder="Enter Desired Mother Tongue" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="desired_age" name="desired_age" placeholder="Enter Desired Age" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="desired_height" name="desired_height" placeholder="Enter Desired Height" maxlength="100" required />
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="desired_annual_income" name="desired_annual_income" placeholder="Enter Desired Annual Income" maxlength="100" required />
                                <div class="invalid-feedback">
                            ...
                            <div data-repeater-list="group-a">
                                <div data-repeater-item class="row">
                                    <div class="col-lg-2 col-md-4">
                                        <div class="small-pic">
                                            <img class="imagePreview2 imgdisplay" alt="" width="100" height="100" src="{{URL::asset('images/image-placeholder.jpg')}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-2">
                                        <button type="button" data-repeater-delete data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-sm btn-danger margin-10 mt-2">
                                ...
                                <div data-repeater-list="group-c">
                                    <div data-repeater-item class="row">
                                        ...
                                        <div class="col-lg-4 align-self-center">
                                            <button type="button" data-repeater-delete data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-sm btn-danger m-15">
                                                <i class="bx bx-trash d-block font-size-16"></i>
                                            </button>
                                        </div>
                                    </div>
