...
@slot('title') Testimonial List @endslot
@slot('li_1') <a class=''>Testimonial</a> @endslot
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive custom_tabal_saction_part">
                    <h4 class="card-title" style="text-align:right;"><a href="{{route('testimonial.create')}}"
...
$(function() {
    ...
    var dt = $('#testmonialList').DataTable({
        ...
        rowReorder: true,
        ajax: {
            url: "{{ url('/admin/testimonial/testimonialList') }}",
        },
...
function ViewTestmonialDetail(id)
    {
        window.location.href = "/admin/testimonial/details/" + id;
    }
</script>
